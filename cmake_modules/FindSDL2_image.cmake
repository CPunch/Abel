...
# include libpng for SDL2_image if it's static `.a` library
if(SDL2_IMAGE_LIBRARY AND NOT SDL2_IMAGE_LIBRARY MATCHES ".*\\.a$")
  find_package(PNG REQUIRED)
  if(PNG_FOUND)
    set(SDL2_IMAGE_LIBRARIES ${SDL2_IMAGE_LIBRARY} ${PNG_LIBRARIES})
    set(SDL2_IMAGE_INCLUDE_DIRS ${SDL2_IMAGE_INCLUDE_DIR} ${PNG_INCLUDE_DIRS})
  endif()
else()
